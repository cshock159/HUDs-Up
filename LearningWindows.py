...
start_stop = [
    ...
    [sg.Button(button_text="Start", size=(10,3),button_color="Green",bind_return_key=True,tooltip="Start HUDs-Up with the options chosen below."),
    sg.Button(button_text="Stop", size=(10,3),button_color="red",tooltip="Stops HUDs-Up.")], 
]
...
def threadstart():
    print("Starting HUDs-UP with image: " + image_file)
