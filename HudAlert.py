...
audio_autoclose = [
    ...
    [sg.Text(("Allows you to select the frequency that HUDs-Up checks for the HUD"),font=("Comic Sans MS","9"))],
    [sg.Slider(range=(0,60),orientation='h',tick_interval=15,resolution=1,default_value=5,key="frequency",tooltip="Determines the frequency in which HUDs-Up checks for the HUD.")],
